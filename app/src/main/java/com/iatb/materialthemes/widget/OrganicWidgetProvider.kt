...
class OrganicWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        ActiveWidgetManager.recordProviderUpdate(context, OrganicWidgetProvider::class.java, appWidgetIds)
    ...
    override fun onAppWidgetOptionsChanged(
        ...
        ActiveWidgetManager.recordOptionsChanged(context, OrganicWidgetProvider::class.java, appWidgetId, newOptions)
        updateAppWidget(context, appWidgetManager, appWidgetId)
    }
    ...
    companion object {
        ...
        fun updateAppWidget(
            ...
            try {
                ...
                android.util.Log.e("OrganicWidgetProvider", "Error updating widget $appWidgetId", e)
            }
        }
